...
#
# Usage examples:
#   ./scripts/setup-trdp-simulator.sh
#   ./scripts/setup-trdp-simulator.sh --trdp-root ~/git/trdp
#   ./scripts/setup-trdp-simulator.sh --trdp-lib /path/to/libtrdp.a --trdp-include /path/to/trdp/include
#
...
# -----------------------------
# Detect TRDP include / lib if not provided
# -----------------------------
